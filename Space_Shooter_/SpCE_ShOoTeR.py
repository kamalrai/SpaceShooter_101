...
NUT_LASER= pygame.image.load(os.path.join("assets1", "pixel_laser_1.png"))
NAT_LASER= pygame.image.load(os.path.join("assets1", "pixel_laser_2.png"))


#BACKGROUND
BG = pygame.transform.scale(pygame.image.load(os.path.join("assets1", "background1.jpg")), (WIDTH,HEIGHT))
...
class Enemy(Ship):
    COLOR_MAP = {
                ...
                "nut": (NUT_SPACE_SHIP, NUT_LASER),
                "nat": (NAT_SPACE_SHIP, NAT_LASER)
                }
...
def main():
    ...
    def redraw_window():
        ...
        HighScore_label = main_font.render(f"HighScore: {highscore}", 1, (255, 55, 55))
        WIN.blit(HighScore_label, (10, 20))
    ...
    while run:
        ...
        if len(enemies) == 0:
            ...
            for i in range(wave_length):
                enemy = Enemy(random.randrange(50, WIDTH-100), random.randrange(-1500, -100), random.choice(["red", "blue", "green", "pink", "orange", "nut", "nat"]))
